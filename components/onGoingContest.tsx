...
export function OngoingQuizzes(): JSX.Element {
  ...
  if (loading) {
    return (
      <div className="mb-8 dark:bg-[#18181a]">
  ...
  return (
    <div className="mb-8 relative">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white/90">Ongoing Quizzes</h2>
        {quizzes.length > 1 && (
          <div className="flex gap-2">
            ...
            <button
              ...
              className="p-1 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors dark:bg-neutral-400 dark:hover:bg-neutral-500"
      ...
      >
        {quizzes.length > 0 ? (
            ...
            >
              <div className="p-3">
                <div className="flex flex-col h-full">
                  ...
                  <p className="text-sm text-gray-600 dark:text-neutral-400 mb-3 line-clamp-2">{quiz.description}</p>
          ...
          <div className="flex items-center justify-center w-full py-8 text-neutral-500 dark:text-white/90">
