...
export function UpcomingQuizzes(): JSX.Element {
  ...
  if (loading) {
    return (
      <div className="mb-8">
        <h2 className="text-xl font-semibold text-black dark:text-white/90 mb-4">Upcoming Quizzes</h2>
  ...
  return (
    <div className="mb-8 relative">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-black dark:text-white/90">Upcoming Quizzes</h2>
        {quizzes.length > 1 && (
      ...
      >
        {quizzes.length > 0 ? (
          quizzes.map((quiz) => (
            <Card
              key={quiz.id}
              className="flex-shrink-0 w-[30rem] bg-sky-50 dark:bg-[#18181a] dark:border-0 border-[#bdbdbd] border-[1px]"
            >
              <div className="p-4">
