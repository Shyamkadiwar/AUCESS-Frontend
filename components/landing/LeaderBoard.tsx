...
const LeaderBoard = () => {
  return <div className="flex flex-col w-full h-full justify-center items-center overflow-hidden bg-azure-radiance-50 text-black py-12">
    <div className="flex flex-col w-full max-w-7xl px-4">
      ...
      <div className='flex flex-col w-full justify-center items-center'>
        ...
        <div className='flex w-full text-lg md:text-3xl text-center text-neutral-700 font-neue-bold justify-center items-center'>
