...
export default function FAQs() {
  ...
  return (
    <div className="w-full bg-black py-16">
      <ContentContainer>
        <h2 className="text-3xl md:text-5xl font-neue-ultraBold text-white font-neue-machina mb-16">
          FAQs
        </h2>
        ...
        <div className="w-full max-w-3xl mx-auto space-y-4">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="bg-[#171717] border hover:border-azure-radiance-600 dark:hover:border-azure-radiance-50/50 rounded-xl overflow-hidden transition-all"
            >
              <button
