...
const PitchCard = ({ image, title }: { image: string, title: string }) => (
  <div className="flex flex-col bg-azure-radiance-50 dark:bg-white rounded-3xl p-4 py-10 md:py-20">
    ...
    <div className="flex flex-col relative justify-center items-center overflow-hidden w-full h-full my-10">
      <div className="flex flex-col w-full max-w-7xl">
        <div className="flex flex-col gap-4 px-8">
          ...
          <h3 className="text-xl text-neutral-700 dark:text-neutral-300 pb-4 underline">Check Yourself and Earn yourself!</h3>
        </div>
